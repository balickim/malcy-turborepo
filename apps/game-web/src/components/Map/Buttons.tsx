...
export default function Buttons({ mapRef, playerLocation }: IButtons) {
  ...
  return (
    <div>
      <div className="leaflet-bottom leaflet-right z-[1500] mb-5 mr-2 flex flex-col gap-1">
        <div
          ref={drag}
          className="cursor-grab leaflet-control-attribution leaflet-control p-0 flex flex-col !m-0 !bg-inherit"
        ...
        <IonButton
          ...
          className="min-h-8 min-w-16 z-[1500] leaflet-control-attribution leaflet-control p-0 flex flex-col !m-0 !bg-inherit"
        >
